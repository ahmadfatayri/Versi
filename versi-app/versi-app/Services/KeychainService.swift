...
//  versi-app
//
//  Created by Ahmad Fatayri on 5/3/19.
...
class KeychainService: NSObject {
    ...
    class func removeKey(service: String, account:String) {
    ...
    class func saveKey(service: String, account:String, data: String) {
    ...
    class func loadKey(service: String, account:String) -> String? {
        // Instantiate a new default keychain query
